            ...
            <div class="flex flex-wrap -m-4" v-if="!products.length">
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full mb-4">
                    <a class="block relative h-48 rounded overflow-hidden">
                        <img src="https://dummyimage.com/420x260/9c889c/c1c1c7" class="object-cover object-center w-full h-full block" alt="ecom img">
                    </a>
                    <div class="mt-4">
                        <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1 uppercase inline-block mr-2">N/A</h3>
                        <h2 class="xl:text-gray-900 title-font text-lg font-medium">Loading</h2>
                        <p class="mt-1">$0.00</p>
                    </div>
                </div>
            </div>
            <div class="flex flex-wrap -m-4" v-else>
                ...
                >
                    ...
                    <div class="mt-4">
                        ...
                        <h2
                            class="xl:text-gray-900 title-font text-lg font-medium"
                            v-text="product.name"
                        ></h2>
