    ...
    <section class="text-gray-700 body-font overflow-hidden" v-if="product">
        <div class="container px-12 py-24 mx-auto">
            <div class="lg:w-3/5 mx-auto flex flex-wrap">
                <img src="https://dummyimage.com/640x640/9c889c/c1c1c7" class="lg:w-1/2 lg:h-auto object-cover object-center w-full h-full block" alt="ecom img">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2
                        class="text-gray-500 text-sm tracking-widest title-font mb-1 uppercase inline-block mr-2"
