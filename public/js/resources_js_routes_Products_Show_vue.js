        ...
        [
          _c("div", { staticClass: "container px-12 py-24 mx-auto" }, [
            _c("div", { staticClass: "lg:w-3/5 mx-auto flex flex-wrap" }, [
              _c("img", {
                staticClass:
                  "lg:w-1/2 lg:h-auto object-cover object-center w-full h-full block",
                attrs: {
                  src: "https://dummyimage.com/640x640/9c889c/c1c1c7",
                  alt: "ecom img"
                }
              }),
              _vm._v(" "),
              _c(
                ...
                [
                  _vm._l(_vm.product.categories, function(category) {
                    return _c("h2", {
                      staticClass:
                        "text-gray-500 text-sm tracking-widest title-font mb-1 uppercase inline-block mr-2",
