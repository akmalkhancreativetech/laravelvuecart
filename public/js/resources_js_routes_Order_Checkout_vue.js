              ...
              _vm._l(_vm.cart, function(item, index) {
                return _c("tr", { key: item.id }, [
                  ...
                  _c("td", {
                    staticClass: "p-4",
                    domProps: {
                      textContent: _vm._s(_vm.productPrice(item.price))
                    }
                  }),
                  _vm._v(" "),
                  _c("td", {
                  ...
                  _c("td", { staticClass: "w-10 text-right" }, [
                    _c(
                      ...
                      {
                        staticClass:
                          "flex ml-auto text-sm text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none",
                        on: {
        ...
        _c("div", { staticClass: "p-2 w-1/3" }, [
          _c("div", { staticClass: "relative" }, [
            ...
            _c("input", {
              ...
              staticClass: "w-full bg-gray-100 rounded border-gray-300 py-2",
              attrs: {
                type: "text",
                id: "first_name",
                name: "first_name",
                disabled: _vm.paymentProccessing
              },
